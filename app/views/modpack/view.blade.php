		...
		<table class="table table-striped table-bordered table-hover" id="dataTables">
			...
			@foreach ($modpack->builds as $build)
				<tr>
					...
					<td>
						{{ HTML::link('modpack/add-build/'.$modpack->id.'/'.$modpack->id.'/'.$build->id, "Clone",'class="btn btn-xs btn-success"') }}
						{{ HTML::link('modpack/build/'.$build->id, "Manage",'class="btn btn-xs btn-primary"') }}
						{{ HTML::link('modpack/build/'.$build->id.'?action=edit', "Edit",'class="btn btn-xs btn-warning"') }}
